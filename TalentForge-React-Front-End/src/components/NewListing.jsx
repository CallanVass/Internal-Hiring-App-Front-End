...
const NewListing = () => {
  return (
    <>
    <div className='flex flex-col m-3 md:m-5 mx-8 md:mx-16 lg:mx-80 lg:my-2'>
        {/* Title */}
        ...
        {/* Form: job title/dept/date */}
            <div className='pt-10 pb-4 md:pt-10 md:pb- lg:pt-10 lg:pb-4'>
                <form className='space-y-4 md:space-y-4 lg:space-y-4 text-lg md:text-2xl lg:text-lg'>
            ...
            <div className='mt-5 md:mt-5 lg:mt-5 py-2'>
                <ul className='space-y-2 text-lg md:text-2xl lg:text-3xl'>
                    <legend className='text-xl md:text-3xl lg:text-4xl font-bold'>Role Basis:</legend>
                    <div>
                        <li>
            ...
            <div className='mt-2 md:mt-2 lg:mt-2 py-3 md:py-3 lg:py-3 border-t-2 md:border-t-2 lg:border-t-2 border-dotted'>
                <ul className='space-y-2 text-lg md:text-2xl lg:text-3xl'>
                    <legend className='text-xl md:text-3xl lg:text-4xl font-bold'>Role type:</legend>
                    <div>
                        <li>
            ...
            <div className='mt-2 md:mt-2 lg:mt-2 py-3 md:py-3 lg:py-3 border-t-2 md:border-t-2 lg:border-t-2 border-dotted'>
                <ul className='space-y-2 text-lg md:text-2xl lg:text-3xl'>
                    <legend className='text-xl md:text-3xl lg:text-4xl font-bold'>Role location:</legend>
                    <div>
                        <li>
            ...
            <div className='border-t-2 md:border-t-2 lg:border-t-2 border-dotted'>
                ...
                <div className='my-5 md:my-4 lg:my-4'>
                    ...
                    <form className="mt:4 md:mt-8 lg:mt-8 text-lg md:text-2xl lg:text-3xl">
                        <label htmlFor="job-desc-input" className='font-normal leading-tight text-blue-gray-400'>Full description:</label>
                        <textarea name="job-description" id="job-desc-input" className="form-input text-xl md:text-2xl lg:text-3xl w-full h-80 md:h-80 lg:h-80 block overflow-y-auto rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 placeholder='Full Description' placeholder-gray-400 placeholder-shown:text-sm placeholder-shown:leading-[3.75] "></textarea>
            ...
            <div className='flex justify-center'>
                ...
                <button type="submit" className='className="bg-white hover:bg-dark-blue text-dark-blue font-semibold text-2xl md:text-3xl hover:text-white m-2 py-1 px-5 h-12  min-w-72 max-w-screen border border-blue-500 hover:border-transparent rounded'>Save</button>
                <button type="submit" className='className="bg-white hover:bg-dark-blue text-dark-blue font-semibold text-2xl md:text-3xl hover:text-white m-2 py-1 px-5 h-12  min-w-72 max-w-screen border border-blue-500 hover:border-transparent rounded'>Close</button>
            </div>
            </div>
